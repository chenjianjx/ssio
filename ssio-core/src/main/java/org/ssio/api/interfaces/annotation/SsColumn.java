...
public @interface SsColumn {
    ...
    /**
     * If the property is not of a simple type supported by {@link SimpleType}, you need to provider a handler here to make conversions between your complex type and a supported simple type.
