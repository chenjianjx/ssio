...
public class BeanClassInspector {
    ...
    List<PropAndColumn> getPropAndColumnMappings(Class<?> beanClass, SsioMode ssioMode,
        ...
        for (Object o : fieldsAndMethods) {
            ...
            SimpleType ssioSimpleType = SimpleType.fromRealType(propTypeForSheet);
            if (ssioSimpleType == null) {
                ...
                errors.add(String.format("The final type of property '%s', which is %s, is not supported. The list of supported types are defined in %s . %s", propName, propTypeForSheet.getName(), SimpleType.class.getName(), suggestion));
                continue;
            }
            ...
            pac.setSimpleTypeEnum(ssioSimpleType);
